		...
		\begin{table} \tiny
			\begin{tabular}{|p{1.25cm}|p{.75cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|p{1.3cm}|}
				\hline
					...
					& \textbf{time}
					&	\thead{ \textbf{Day 1:} \\  April 24, 2023}
					& \thead{ \textbf{Day 2:} \\  April 25, 2023}
					& \thead{ \textbf{Day 3:} \\  April 26, 2023}
					& \thead{ \textbf{Day 4:} \\  April 27, 2023}
					& \thead{ \textbf{Day 5:} \\  April 28, 2023}
					\\
				\hline
					\textbf{Lectures}
					& 10-12h
