			...
			\begin{columns}
				\begin{column}{0.66\textwidth}
					\begin{center}
						...
						\only<2>{\includegraphics[width=.7\textwidth]{FEstatic.png}}
					\end{center}
				\end{column}
				\begin{column}{0.33\textwidth}
					\onslide<3>{
...
\section{Staggered treatment}
	...
	\subsection{intuition}
		\begin{frame}{notation}
			Turns out the 2WFE DiD estimator is a weighted average of all these comparisons
			\begin{center}
				\includegraphics[width=.5\textwidth]{GB_staggeredDiff.jpg}
	...
	\subsection{solutions}
		\begin{frame}{Proposed solutions}
			...
			\begin{itemize}
				...
				\item<3-> \cite{Goodman-Bacon2018}
					\begin{itemize}
						\item a time-in-treatment weighted DiD
					\end{itemize}
				\item<4-> \cite{Callaway2020}
					\begin{itemize}
						\item semiparametric, bootstrapped inference with pre-intervention conditioning on co-variates
						\item R package \href{https://cran.r-project.org/web/packages/did/vignettes/did-basics.html}{\underline{\smash{did}}}
					\end{itemize}
				\item<5-> \cite{Sun2020a}
					\begin{itemize}
						\item a time-to-treatment (cohort) weighted approach
		...
		\begin{frame}{Summary}
			...
			\begin{itemize}
				...
				\item constantly being developed further
			\end{itemize}
		\end{frame}
