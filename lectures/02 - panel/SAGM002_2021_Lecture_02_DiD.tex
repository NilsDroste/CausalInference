		...
		\begin{frame}{Panel Data}
			...
			\begin{table}
				...
				\begin{tabular}{|p{1.8cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}||p{1.6cm}|}
					\hline
					\textbf{individual (i)} & \textbf{time (t)} & $\textbf{Y}_i$ & $\textbf{X}_i$ & $\textbf{D}_{it}$ \\
					\hline
					A & 1 & 0.8 & 0.3 & 0 \\
					A & 2 & 0.7 & 0.2 & 0 \\
					A & 3 & 0.5 & 0.2 & 1 \\
	...
	\subsection{solutions}
		...
		\begin{frame}{Summary}
			\begin{center}
				...
				\captionof{figure}{\href{https://twitter.com/davidfromterra/status/1390649644418584579?s=20}{\underline{\smash{Schönholzer 2021}}}, cf. \cite{Roth2021a}}
			\end{center}
		\end{frame}
