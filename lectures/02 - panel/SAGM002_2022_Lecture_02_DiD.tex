...
\section{Staggered treatment}
	...
	\subsection{solutions}
		...
		\begin{frame}{Non-parallel trends}
			...
			\\ \vspace*{.25cm}
			\begin{itemize}
				\item Jonathan Roth \citeyear{Roth2022}
					\begin{itemize}
		...
		\begin{frame}{Summary}
			\begin{center}
				...
				\captionof{figure}{\href{https://twitter.com/davidfromterra/status/1390649644418584579?s=20}{\underline{\smash{Schönholzer 2022}}}, cf. \cite{Roth2022a}}
			\end{center}
		\end{frame}
