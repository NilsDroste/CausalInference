...
\section{Synthetic Controls}
	...
	\subsection{estimation}
		...
		\begin{center}
			\includegraphics[trim={6.5cm 5.25cm 5cm 5cm}, clip, width=.55\textwidth]{OLS.jpg}
				\\\tiny{OLS, img source: \href{https://serokell.io/blog/regression-analysis-overview}{\underline{\smash{Gavrilova, 2020}}}}
		\end{center}
		\end{frame}
	...
	\subsection{example}
		...
		\begin{frame}{an example}
			...
			\begin{center}
				\only<1>{\begin{center}\includegraphics[width=.5\textwidth]{Bayer1.jpg} \\\tiny{Effect of the EU ETS over time, source: \cite{Bayer2020}}\end{center}}
				\onslide<2>{\includegraphics[width=.5\textwidth]{Bayer2.jpg}}
				\\\tiny{Effect of the EU ETS over time, source: \cite{Bayer2020}}
			\end{center}
		\end{frame}
