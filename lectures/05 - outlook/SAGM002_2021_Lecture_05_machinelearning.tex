...
\section{machine learning}
	...
	\subsection{causal trees}
		...
		\begin{frame}{causal trees}
			...
			\onslide<2>{
				and repeat to build an ensemble of trees $\rightarrow$ random forests. This particularly well suited for heterogeneous treatment effects. Athey and Imbens (\citeyear{Athey2016}) suggest a sort of cross validation procedure for robust causal inference, see \href{https://grf-labs.github.io/grf/}{\underline{\smash{generalized random forests R package}}}.
				}
		\end{frame}
