---
title: 'Advanced Seminar II: Regression Discontinuity Analysis'
author: "YOUR NAME & Nils Droste"
...
Data replication sets are available in Harvard Datavers at https://dx.doi.org/10.7910/DVN/KYSD5S and online appendices at https://doi.org/10.1017/S0007123418000029.
...
library(here)
library(magrittr)
source( './functions/rrp_rdd_functions.R' )
```
